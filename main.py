...
def title():
    stdout.write("                                                                                          \n")
    stdout.write("                                 "+Fore.LIGHTWHITE_EX  +"|\     /|(  ___  )\__   __/(  ___  )| \    /\\__   __/  |\     /|/ ___  \                  \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   +"| )   ( || (   ) |   ) (   | (   ) ||  \  / /   ) (     | )   ( |\/   \  \                 \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   +"| (___) || (___) |   | |   | |   | ||  (_/ /    | |     | |   | |   ___) /                \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   +"|  ___  ||  ___  |   | |   | |   | ||   _ (     | |     ( (   ) )  (___ (                \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   +"| (   ) || (   ) |   | |   | |   | ||  ( \ \    | |      \ \_/ /       ) \              \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   +"| )   ( || )   ( |   | |   | (___) ||  /  \ \___) (___    \   /  /\___/  /                \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   +"|/     \||/     \|   )_(   (_______)|_/    \/\_______/     \_/   \______/                \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Welcome To The Main Screen Of HATOKIV3  "+Fore.LIGHTCYAN_EX  +"       ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Type [help] to see the Commands    "+Fore.LIGHTCYAN_EX +"       ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"         Contact Dev - Telegram @duykhuong200x   "+Fore.LIGHTCYAN_EX +"        ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"╔═══"+Fore.LIGHTCYAN_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTCYAN_EX+"HATOKIV3"+Fore.CYAN+"]"+Fore.LIGHTCYAN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
